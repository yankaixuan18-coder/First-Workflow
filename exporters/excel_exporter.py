...
COLUMNS = [
    ...
    ("seller_sprite_monthly_sales", "月销量(Monthly Sales)"),
    ("seller_sprite_monthly_revenue","月销售额(Monthly Revenue)"),
    ("seller_sprite_review_growth", "评论增长(Review Growth)"),
    ("seller_sprite_rating_trend",  "评分趋势(Rating Trend)"),
    ("seller_sprite_search_volume", "关键词搜索量(Search Volume)"),
